...
var die1 = { "eyes": 5, "checked": false };
var die2 = { "eyes": 1, "checked": false };
var die3 = { "eyes": 2, "checked": false };
var die4 = { "eyes": 3, "checked": false };
var die5 = { "eyes": 4, "checked": false };
       ...
       //    $(".diceList > div").css("background", "#ffe6e6");
        ...
        $.ajax({
            ...
            success: function (data, status) {
                document.getElementById("die1").innerHTML = data[0].Eyes;
                document.getElementById("die2").innerHTML = data[1].Eyes;
