...
var die1 = { eyes: 0, checked: false }
var die2 = { eyes: 0, checked: false }
var die3 = { eyes: 0, checked: false }
var die4 = { eyes: 0, checked: false }
var die5 = { eyes: 0, checked: false }
...
function RollDice() {
    ...
    //    $("#die1").hide();
        ...
        $.ajax({
            type: 'POST',
            url: 'http://localhost:22090/api/yatzyGame/',
            cache: false,
